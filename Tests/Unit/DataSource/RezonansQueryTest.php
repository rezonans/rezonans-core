...
namespace Rezonans\Core\Tests\Unit\DataSource;

use Rezonans\Core\DataSource\RezonansQuery;
use Rezonans\Core\Flow\Path;
use Rezonans\Core\Tests\TestCase;
use Rezonans\Core\Wordpress\WpPost;
use Rezonans\Core\Wordpress\WpProvider;
use Rezonans\Core\Wordpress\WpQuery;

class RezonansQueryTest extends TestCase
{
    ...
    {
        //Arrange
        $rezonansQuery = new RezonansQuery();
        ...
        //Act
        $data = $rezonansQuery->addPostData(function (&$data, $post) {
